    ...
    return (
        <div className='max-w-lg mx-auto p-3 w-full'>
            ...
            <div className='text-red-500 flex justify-between mt-5'>
                <span onClick={() => setShowModal(true)} className='cursor-pointer hover:text-red-700'>Delete Account</span>
                <span onClick={handleSignout} className='cursor-pointer hover:text-red-700'>Sign Out</span>
            </div>
            ...
            <Modal
                ...
                <ModalBody>
                    <div className='text-center'>
                        ...
                        <h3 className='mb-5 text-lg text-gray-500 dark:text-gray-400'>Are you sure you want to delete tour account?</h3>
